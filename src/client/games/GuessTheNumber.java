...
public class GuessTheNumber extends JPanel {
	...
	protected void guessNum() {
		...
		if(guess.getText().equals("") || guess.getText().equals(null) || num > 100 || num < 0) {
			Client.sendMessage("Error, number was empty, please enter a valid number between 0 and 100");
			return;
		}
		if(num > randomNum) {
		...
		tries--;
		Client.sendMessage("Congratulations, you've guessed the number right! It was "+num+". Exit this prompt to play again!");
	...
	private void resetGame() {
		...
		guess.setText("");
		triesLbl.setText("Tries left: "+tries);
		randomNum = generateNumber(0, 100);
	}
